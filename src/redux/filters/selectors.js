    ...
    if (sort.length > 0) {
      ...
      sort.forEach((sortOption) => {
        if (sortOption === "popular") {
          sortedNotices.sort((a, b) => (b.popularity || 0) - (a.popularity || 0));
        } else if (sortOption === "unpopular") {
          sortedNotices.sort((a, b) => (a.popularity || 0) - (b.popularity || 0));
        } else if (sortOption === "cheap") {
          sortedNotices.sort((a, b) => (Number(a.price) || 0) - (Number(b.price) || 0));
        } else if (sortOption === "expensive") {
          sortedNotices.sort((a, b) => (Number(b.price) || 0) - (Number(a.price) || 0));
        }
      });
